...
function createRequestLogger(transports) {
    ...
    var opts = { filename: 'sampleCatalogApiQuery-%DATE%.log', dirname: logDir, datePattern: 'YYYY-MM-DD' , zippedArchive: true, maxSize: '20m', maxFiles: '14d' };
...
function createErrorLogger(transports) {
    ...
    var opts = { filename: 'samplecatalogapi-error-%DATE%.log', dirname: logDir, datePattern: 'YYYY-MM-DD' , zippedArchive: true, maxSize: '20m', maxFiles: '14d' };
